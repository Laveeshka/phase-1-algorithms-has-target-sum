...
/*
  ...
  Start looping through each element of the array
    ...
    Perform a check - does the tracking array include the difference? If yes, we have found the numbers(current element and the difference value) which sum yield the target
  ...
  Start looping through each element of the array
    Calculate the difference between the target and the current element
    Perform a check - does the tracking set include the difference? If yes, we have found the numbers(current element and the difference value) which sum yield the target
